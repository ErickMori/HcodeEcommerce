...
class User extends Model{
    ...
    public function update(){
        ...
        $results = $sql->select("CALL sp_usersupdate_save(:iduser, :desperson, :deslogin, :despassword, :desemail, :nrphone, :inadmin)", array(
            ...
            ":desperson"=>utf8_decode($this->getdesperson()),
            ":deslogin"=>$this->getdeslogin(),
           //":despassword"=>User::getPasswordHash($this->getdespassword()),     CODIGO QUE CRIPTOGRAFA
        ...
        $_SESSION[User::SESSION]["despassword"]=$this->getdespassword();        
        $_SESSION[User::SESSION]["desperson"]=$this->getdesperson();
    ...
    public static function getForgot($email, $inadmin = true){
        ...
        if($inadmin === true){
            $link = "http://local.websup.com/admin/forgot/reset?code=$code";
        }else{
            $link = "http://local.websup.com/forgot/reset?code=$code";
        }
        
        $mailer = new Mailer($data["desemail"], 
        ucfirst($data["desperson"]), 
            "Redefinir Senha Suplauto",
            "forgot", array(
                "name"=>ucfirst($data["desperson"]),
                "link"=>$link
        ));
