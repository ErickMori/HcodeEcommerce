...
<head>
  ...
  <title>Suplauto | E-commerce</title>
  <!-- Icone -->
  <link rel="icon" href="/views/favicon_admin.png" />
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/products"><i class="fa fa-puzzle-piece"></i> <span>Produtos</span></a></li>
        <li><a href="/admin/orders"><i class="fa fa-puzzle-piece"></i> <span>Pedidos</span></a></li>
